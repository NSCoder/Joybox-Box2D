...
{
  B2DFilter *firstFilter = [[B2DFilter alloc] init];
  ...
  B2DFilter *secondFilter = [[B2DFilter alloc] init];
  secondFilter.categoryBits = 0x002;
  secondFilter.maskBits = 0xFF0F;
  secondFilter.groupIndex= 1;
